    ...
    return LaunchDescription([
        ...
        Node(
           ...
           arguments=[
             ...
             '/model/elm4s/odometry_with_covariance@nav_msgs/msg/Odometry@gz.msgs.OdometryWithCovariance',
             # Sensors
             '/world/default/model/elm4s/link/RPLIDAR_A1M8/Base/sensor/lidar/scan@sensor_msgs/msg/LaserScan[gz.msgs.LaserScan',
             # ros args
